...
read_csv("data/clean/Pres_Election_Data_2016i.csv", col_types = cols())
```
...
read_csv("data/clean/Pres_Election_DatA_2016i.csv") %>% 
  inner_join(read_csv("data/clean/Unemployment.csv")) %>% 
  inner_join(read_csv("data/clean/CC-EST2015-ALLDATA.csv")) %>%
  inner_join(read_csv("data/clean/County_Data_2016_health_insurance.csv"))
```